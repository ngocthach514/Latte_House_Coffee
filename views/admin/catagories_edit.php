        ...
        <div class="m-main item-form">
            <div class="submit-btn-gr d-flex justify-content-between m-2">
                ...
                <div class="d-flex gap-2">
                    ...
                    <input type="submit" class="btn btn-primary" value="Lưu thay đổi" name="update_dm">
                </div>
            </div>
                    ...
                    <div class="description">
                        ...
                        <div class="content row m-2 border border-secondary-subtle rounded-1 pt-2 pb-2">
                            <div>
                                ...
                                <input placeholder="<?php echo''.$cate['Name_DM'].''?>" type="text" class="form-control"
                                    id="validationName" required value="<?php echo''.$cate['Name_DM'].''?>" name="Name_DM">
                            ...
                            <div>
                                ...
                                <textarea class="form-control" id="validationDescription"
                                    placeholder="<?php echo''.$cate['Decribes'].''?>"
                                    required name="Decribes"><?php echo''.$cate['Decribes'].''?></textarea>
                                <div class="invalid-feedback">
